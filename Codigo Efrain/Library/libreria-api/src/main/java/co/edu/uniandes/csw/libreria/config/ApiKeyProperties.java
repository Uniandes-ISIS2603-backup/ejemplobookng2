...
package co.edu.uniandes.csw.libreria.config;
...
public class ApiKeyProperties extends Properties {
    ...
    public ApiKeyProperties() {
        super.put(ID_PROP, System.getenv("CSW_STORMPATH_API_KEY_ID"));
        super.put(SECRET_PROP, System.getenv("CSW_STORMPATH_API_KEY_SECRET"));
    }
